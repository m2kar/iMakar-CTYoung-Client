...
public final class PerspectiveTransform
{
    ...
    public static PerspectiveTransform squareToQuadrilateral(float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7)
    {
        ...
        } else
        {
            ...
            f4 = ((f - f2) + f4) - f6;
            f5 = f3 - f5;
            float f12 = f9 * f10 - f11 * f5;
            f10 = (f4 * f10 - f11 * f8) / f12;
            f4 = (f9 * f8 - f4 * f5) / f12;
            return new PerspectiveTransform((f2 - f) + f10 * f2, (f6 - f) + f4 * f6, f, f10 * f3 + (f3 - f1), f4 * f7 + (f7 - f1), f1, f10, f4, 1.0F);
        }
    }
