...
final class BitMatrixParser
{
    ...
    BitMatrix extractDataRegion(BitMatrix bitmatrix)
    {
        ...
        int i2 = k / k1;
        int j2 = i / l1;
        BitMatrix bitmatrix1 = new BitMatrix(i2 * k1);
        for(int j = 0; j < i2; j++)
        {
            for(int l = 0; l < j2; l++)
            {
...
_L1:
        int l = k + 1;
        abyte0[k] = (byte)readCorner1(j2, j2);
        j -= 2;
        i += 2;
        flag3 = true;
        k = l;
...
_L2:
        if(j == j2 - 2 && i == 0 && (j2 & 3) != 0 && !flag2)
        {
            int i1 = k + 1;
            abyte0[k] = (byte)readCorner2(j2, j2);
            j -= 2;
            i += 2;
            flag2 = true;
            k = i1;
...
label0:
            {
                if(j != j2 + 4 || i != 2 || (j2 & 7) != 0 || flag1)
                    break label0;
                int j1 = k + 1;
                abyte0[k] = (byte)readCorner3(j2, j2);
                j -= 2;
                i += 2;
                flag1 = true;
                k = j1;
...
_L7:
        ...
        k1 = k;
        l1 = j;
        if((j2 & 7) != 4) goto _L6; else goto _L8
_L8:
        i2 = i;
        k1 = k;
        l1 = j;
...
_L9:
        k1 = k + 1;
        abyte0[k] = (byte)readCorner4(j2, j2);
        j -= 2;
        i += 2;
        flag = true;
        k = k1;
...
_L6:
        ...
        {
            i = k1 + 1;
            abyte0[k1] = (byte)readUtah(l1, i2, j2, j2);
        } else
        {
            i = k1;
        }
        l1 -= 2;
        i2 += 2;
        if(l1 >= 0 && i2 < j2) goto _L11; else goto _L10
_L10:
        k1 = l1 + 1;
        j = i2 + 3;
_L12:
        if(k1 >= 0 && j < j2 && !readMappingMatrix.get(j, k1))
        {
            k = i + 1;
            abyte0[i] = (byte)readUtah(k1, j, j2, j2);
        } else
        {
            k = i;
        }
