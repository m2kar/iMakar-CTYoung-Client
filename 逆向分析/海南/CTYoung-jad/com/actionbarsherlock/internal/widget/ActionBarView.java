...
//            IcsLinearLayout, ActionBarContextView, ActionBarContainer, IcsAdapterView
...
;
    ...
    public ActionBarView(Context context, AttributeSet attributeset)
    {
        ...
        mSubtitleStyleRes = attributeset.getResourceId(4, 0);
        ...
        mContentHeight = attributeset.getLayoutDimension(3, 0);
...
_L5:
        ...
        if(obj != null)
        {
            ...
            if(obj1 != null)
            {
                ...
                j2 = ((com.actionbarsherlock.app.ActionBar.LayoutParams) (obj1)).topMargin + ((com.actionbarsherlock.app.ActionBar.LayoutParams) (obj1)).bottomMargin;
            }
            if(mContentHeight <= 0)
                l = 0x80000000;
            else
