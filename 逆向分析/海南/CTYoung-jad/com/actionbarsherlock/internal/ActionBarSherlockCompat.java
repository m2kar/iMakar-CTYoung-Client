...
_L7:
        j = i;
        if(!"uiOptions".equals(xmlresourceparser.getAttributeName(l))) goto _L9; else goto _L8
_L8:
        j = i;
        k = xmlresourceparser.getAttributeIntValue(l, 0);
_L4:
        j = k;
...
_L12:
        ...
        j = i;
        if(!"uiOptions".equals(s3)) goto _L15; else goto _L14
_L14:
        j = i;
...
_L3:
    ...
    public boolean onMenuItemClick(MenuItem menuitem)
    {
        ...
        if(menuitemimpl != null)
            ...
            Log.e("ActionBarSherlock", (new StringBuilder()).append("Options item \"").append(menuitem).append("\" not found in mapping").toString());
        return true;
    }
