    ...
    implements android.app.ActionBar.OnNavigationListener, android.app.ActionBar.OnMenuVisibilityListener
{
    ...
    {
        for(Iterator iterator = mMenuVisibilityListeners.iterator(); iterator.hasNext(); ((com.actionbarsherlock.app.ActionBar.OnMenuVisibilityListener)iterator.next()).onMenuVisibilityChanged(flag));
    }
    ...
    {
        android.app.ActionBar.LayoutParams layoutparams1 = new LayoutParams(layoutparams);
