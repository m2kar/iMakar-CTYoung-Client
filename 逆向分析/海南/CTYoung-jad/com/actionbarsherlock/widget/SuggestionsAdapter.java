    ...
    implements android.view.View.OnClickListener
{
    ...
    {
        super(context, com.actionbarsherlock.R.layout.abs__search_dropdown_item_icons_2line, null, true);
        mClosed = false;
        mQueryRefinement = 1;
        mText1Col = -1;
        mText2Col = -1;
...
_L2:
        ...
        obj = mProviderContext.getResources().getDrawable(i);
...
_L3:
    ...
    public Cursor getSuggestions(String s, int i)
    {
        Object obj;
        if(mSearchable != null)
            if((obj = mSearchable.getSuggestAuthority()) != null)
            {
                android.net.Uri.Builder builder = (new android.net.Uri.Builder()).scheme("content").authority(((String) (obj))).query("").fragment("");
                obj = mSearchable.getSuggestPath();
                if(obj != null)
                    builder.appendEncodedPath(((String) (obj)));
                builder.appendPath("search_suggest_query");
                String s1 = mSearchable.getSuggestSelection();
                obj = null;
                if(s1 != null)
                {
                    obj = new String[1];
                ...
                obj = builder.build();
                return mContext.getContentResolver().query(((Uri) (obj)), null, s1, s, null);
            }
        return null;
    }
...
_L1:
        return null;
_L2:
        if((charsequence = getSuggestions(charsequence, 50)) == null) goto _L1; else goto _L3
_L3:
        try
        {
