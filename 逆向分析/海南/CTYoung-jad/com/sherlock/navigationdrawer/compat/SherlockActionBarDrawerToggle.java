...
//            SherlockActionBarDrawerToggleCompat, SherlockActionBarDrawerToggleHoneycomb

public class SherlockActionBarDrawerToggle
    implements android.support.v4.widget.DrawerLayout.DrawerListener
{
    ...
    private static class ActionBarDrawerToggleImplCompat
        implements ActionBarDrawerToggleImpl
    {
        ...
        {
            return SherlockActionBarDrawerToggleCompat.setActionBarDescription(obj, activity, i);
        }

        public Object setActionBarUpIndicator(Object obj, Activity activity, Drawable drawable, int i)
        {
            return SherlockActionBarDrawerToggleCompat.setActionBarUpIndicator(obj, activity, drawable, i);
        }

        private ActionBarDrawerToggleImplCompat()
        {
        }
        ...
        implements ActionBarDrawerToggleImpl
    {
        ...
        public Object setActionBarDescription(Object obj, Activity activity, int i)
        {
            return SherlockActionBarDrawerToggleHoneycomb.setActionBarDescription(obj, activity, i);
        }

        public Object setActionBarUpIndicator(Object obj, Activity activity, Drawable drawable, int i)
        {
            return SherlockActionBarDrawerToggleHoneycomb.setActionBarUpIndicator(obj, activity, drawable, i);
        }
    ...
    public SherlockActionBarDrawerToggle(Activity activity, DrawerLayout drawerlayout, int i, int j, int k)
    {
