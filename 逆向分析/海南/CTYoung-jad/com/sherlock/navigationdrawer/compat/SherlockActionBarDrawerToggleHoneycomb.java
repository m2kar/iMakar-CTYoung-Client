...
public class SherlockActionBarDrawerToggleHoneycomb
{
...
_L1:
    ...
    public SherlockActionBarDrawerToggleHoneycomb()
    {
    }
    ...
    public static Object setActionBarDescription(Object obj, Activity activity, int i)
    {
        ...
        if(((SetIndicatorInfo) (obj)).setHomeAsUpIndicator != null)
            ...
            {
                Log.w("SherlockActionBarDrawerToggleHoneycomb", "Couldn't set content description via JB-MR2 API", ((Throwable) (obj)));
                return obj1;
            }
        return obj1;
    }
    ...
    public static Object setActionBarUpIndicator(Object obj, Activity activity, Drawable drawable, int i)
    {
        ...
        if(((SetIndicatorInfo) (obj)).setHomeAsUpIndicator != null)
        {
            ...
            {
                Log.w("SherlockActionBarDrawerToggleHoneycomb", "Couldn't set home-as-up indicator via JB-MR2 API", ((Throwable) (obj)));
                return obj1;
            }
            return obj1;
        }
